...
export default function ProjectCard({ project, onDelete, onUpdateTitle, onUpdateClient }) {
  ...
  const handleDeleteClick = (e) => {
    ...
    if (onDelete) {
      console.log('onDelete function exists, calling it');
      onDelete(id);
    } else {
  ...
  const handleTitleSave = (e) => {
    e.preventDefault();
    e.stopPropagation();
    console.log('Updating title for project:', id, 'New title:', newTitle);
    if (onUpdateTitle) {
      console.log('onUpdateTitle function exists, calling it');
      onUpdateTitle(id, newTitle);
    } else {
      console.error('onUpdateTitle function is not defined');
    }
  ...
  const handleClientSave = (e) => {
    e.preventDefault();
    e.stopPropagation();
    console.log('Updating client for project:', id, 'New client:', newClient);
    if (onUpdateClient) {
      console.log('onUpdateClient function exists, calling it');
      onUpdateClient(id, newClient);
    } else {
      console.error('onUpdateClient function is not defined');
    }
