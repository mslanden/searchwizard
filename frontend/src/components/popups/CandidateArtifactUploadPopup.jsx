...
export default function CandidateArtifactUploadPopup({ candidateId, candidateName, onClose, onUpload }) {
  ...
  useEffect(() => {
    // Load artifact types for candidate artifacts
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg shadow-xl max-w-md w-full max-h-[90vh] overflow-y-auto">
        <div className="flex justify-between items-center p-4 border-b">
          <h2 className="text-xl font-semibold text-gray-800">Upload Artifact for {candidateName}</h2>
          <button 
            onClick={onClose} 
        ...
        <form onSubmit={handleSubmit} className="p-6">
          ...
          <div className="mb-6">
            ...
            <textarea
              ...
              className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-brand-purple"
              placeholder="Brief description of the candidate artifact"
              rows="3"
            />
          </div>
